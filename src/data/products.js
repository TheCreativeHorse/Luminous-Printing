...
import vehicleWrapsHero from '../../Public_Assets/Generated/vehicle_wraps_hero.png';
...
export const products = {
    ...
    'vehicle-wraps': {
        title: 'Vehicle Wraps',
        subtitle: 'Striking, professional, and on-the-go advertising',
        description: 'Create lasting impressions with custom vehicle wraps that turn your vehicles into powerful mobile advertisements. Designed to promote your brand wherever you go, vehicle wraps deliver high visibility while maintaining a clean, professional appearance.\n\nBuilt using durable, weather-resistant materials and high-impact visuals, vehicle wraps provide effective on-the-go advertising that works around the clock, helping your brand stand out on streets, highways, and job sites.',
        heroImage: vehicleWrapsHero,
        closing: 'A bold branding solution that keeps your message moving and visible at all times.',
        sections: [
            {
                title: 'What’s included',
                items: [
                    'Full or partial vehicle wrap options',
                    'High-quality, weather-resistant materials',
                    'Vibrant, full-color printing',
                    'Suitable for cars, vans, trucks, and commercial fleets'
                ],
                image: vehicleWrapsHero
            }
        ]
    },
    'labels-stickers': {
